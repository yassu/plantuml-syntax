...
syntax keyword plantumlKeyword actor partition title legend box hide show autonumber newpage neapgage endlegend activate as deactivate a note destroy control create footbox scale == annotation hnote rnote left right top bottom of ref over end
